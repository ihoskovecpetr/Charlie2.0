...
export function useLogicPlusMinusValue(idPlus, idMinus, startValue) {
  ...
  useEffect(() => {
    ...
    document
      .getElementById(idMinus)
      .addEventListener("mousedown", holdingMinus);
    document
      .getElementById(idMinus)
      .addEventListener("touchstart", holdingMinus);

    document.getElementById(idPlus).addEventListener("mouseup", resetTimerPlus);
    document
      .getElementById(idPlus)
      .addEventListener("touchend", resetTimerPlus);
    document
      .getElementById(idPlus)
      .addEventListener("focusout", resetTimerPlus);

    document
      .getElementById(idMinus)
      .addEventListener("mouseup", resetTimerMinus);
    document
      .getElementById(idMinus)
      .addEventListener("touchend", resetTimerMinus);
    document
      .getElementById(idMinus)
      .addEventListener("focusout", resetTimerMinus);

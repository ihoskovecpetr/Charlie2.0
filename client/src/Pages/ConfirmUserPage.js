...
function ConfirmUserPage(props) {
  ...
  const { dataOut } = confirmUserStates.data ? confirmUserStates.data.confirmUser : { dataOut: undefined };
  ...
  console.log("dataOut: ", dataOut);
    ...
    return (
        <Container maxWidth="sm" className={classes.mainContainer}>
          <Grid container direction="column" justify="center" alignItems="center" className={classes.containerGrid} >
            ...
            {dataOut && dataOut.success && <>
                ...
                <Grid item>
                  <Button variant="contained" color="primary" onClick={handleGoMenu}>
                    Go to APP
                  </Button>
                </Grid>
              </>
              }
           {dataOut && !dataOut.success && <Grid item>
                <Typography variant='h6'>confirmation FAILED</Typography>
              </Grid>
              }
          {!dataOut && confirmUserStates && !confirmUserStates.loading && <Grid item>
